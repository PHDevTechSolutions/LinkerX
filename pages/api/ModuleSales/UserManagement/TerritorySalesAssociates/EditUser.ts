...
export default async function editAccount(req: NextApiRequest, res: NextApiResponse) {
  ...
  const { id, UserId, Firstname, Lastname, Email, userName, Password, Role, Department, Location, Company, Manager, TSM } = req.body;
  ...
  try {
    ...
    const updatedUser: any = {
      UserId, Firstname, Lastname, Email, userName, Role, Department, Location, Company, Manager, TSM, updatedAt: new Date(),
    };
