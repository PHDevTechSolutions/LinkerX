...
export default async function editAccount(req: NextApiRequest, res: NextApiResponse) {
  ...
  const { id, UserId, Firstname, Lastname, Email, userName, Password, Role, Department, Location, Company, Status } = req.body;
  ...
  try {
    ...
    const updatedUser: any = {
      UserId, Firstname, Lastname, Email, userName, Role, Department, Location, Company, Status, updatedAt: new Date(),
    };
