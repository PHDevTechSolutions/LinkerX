...
export default async function update(req: NextApiRequest, res: NextApiResponse) {
    ...
    const { id, UserID, userName, DateTime, CompanyName, ContactNumber, PONumber, POAmount, SONumber, SODate, SalesAgent, PaymentTerms, PaymentDate, DeliveryPickupDate, POStatus, POSource, Status } = req.body;
