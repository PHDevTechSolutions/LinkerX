    ...
    <>
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
          ...
          <select id="Company" value={Company || ""} onChange={(e) => setCompany(e.target.value)} className="w-full px-3 py-2 border-b bg-white text-xs bg-gray-50" required>
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
          ...
          <input type="text" value={TargetQuota} onChange={(e) => setTargetQuota(e.target.value)} className="w-full px-3 py-2 border-b bg-white text-xs" />
        </div>
        <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
