    ...
    <>
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          ...
          value={manager} onChange={(e) => setmanager(e.target.value)} className="w-full px-3 py-2 border-b rounded text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="TSM">Territory Sales Manager</label>
          <input type="text" id="tsm" value={tsm} onChange={(e) => settsm(e.target.value)} className="w-full px-3 py-2 border-b rounded text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="referenceid">Territory Sales Associate</label>
          <input type="text" id="referenceid" value={referenceid} onChange={(e) => setreferenceid(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>
      </div>
      ...
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          ...
          <input type="text" id="activitynumber" value={activitynumber} onChange={(e) => setactivitynumber(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="typeactivity">Type of Activity</label>
          <input type="text" id="typeactivity" value={typeactivity} onChange={(e) => settypeactivity(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="callback">Callback</label>
          <input type="datetime-local" id="callback" value={callback} onChange={(e) => setcallback(e.target.value)} className="w-full px-3 py-2 border-b text-xs" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="callstatus">Call Status</label>
          <input type="text" id="callstatus" value={callstatus} onChange={(e) => setcallstatus(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="typecall">Type of Call</label>
          <input type="text" id="typecall" value={typecall} onChange={(e) => settypecall(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="quotationnumber">Quotation Number</label>
          <input type="text" id="quotationnumber" value={quotationnumber} onChange={(e) => setquotationnumber(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="quotationamount">Quotation Amount</label>
          <input type="text" id="quotationamount" value={quotationamount} onChange={(e) => setquotationamount(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="sonumber">SO Number</label>
          <input type="text" id="sonumber" value={sonumber} onChange={(e) => setsonumber(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="soamount">SO Amount</label>
          <input type="text" id="soamount" value={soamount} onChange={(e) => setsoamount(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="area">Actual Sales</label>
          <input type="text" id="actualsales" value={actualsales} onChange={(e) => setactualsales(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="area">Remarks</label>
          <textarea id="remarks" rows={5} value={remarks} onChange={(e) => setremarks(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize"></textarea>
        </div>

        <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
          <label className="block text-xs font-bold mb-2" htmlFor="area">Status</label>
          <input type="text" id="activitystatus" value={activitystatus} onChange={(e) => setactivitystatus(e.target.value)} className="w-full px-3 py-2 border-b text-xs capitalize" />
        </div>
      </div>
    </>
  );
