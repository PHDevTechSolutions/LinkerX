...
interface ButtonActionsProps {
  Role: string; // 👈 NEW: For role-based control
      ...
      <div className="flex grid grid-cols-2 md:grid-cols-1 lg:grid-cols-5 gap-2 mb-3">
        {Role === "Super Admin" && (
          <button
            ...
            className="flex items-center gap-1 px-4 py-2 border border-gray-200 text-dark text-xs shadow-sm rounded-md hover:bg-red-700 hover:text-white"
          >
            <CiTrash size={16} />
        ...
        <button
          ...
          className="flex items-center gap-1 px-4 py-2 border border-gray-200 text-dark text-xs shadow-sm rounded-md hover:bg-blue-900 hover:text-white"
        >
          <CiEdit size={16} />
          ...
          <div className="flex items-center justify-between">
            ...
            {bulkChangeMode && (
              <div className="flex items-center gap-2">
                ...
                <button onClick={handleBulkChange} className="px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-xs" disabled={!newStatus}>
                  Apply Changes
                </button>
              </div>
            )}
