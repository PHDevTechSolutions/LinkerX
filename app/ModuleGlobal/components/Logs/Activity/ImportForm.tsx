    ...
    <div className="bg-white p-4 shadow-md rounded-md">
      ...
      <form onSubmit={handleFileUpload}>
        <div className="flex flex-wrap -mx-4">
          ...
          {/* Quota */}
          <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
            <select value={targetquota} onChange={(e) => settargetquota(e.target.value)} className="w-full px-3 py-2 border-b rounded text-xs capitalize">
          ...
          {/* File Input */}
          <div className="w-full sm:w-1/2 md:w-1/2 px-4 mb-4">
            <input type="file" className="w-full px-3 py-2 border-b rounded text-xs" onChange={handleFileChange} />
          </div>
        </div>
