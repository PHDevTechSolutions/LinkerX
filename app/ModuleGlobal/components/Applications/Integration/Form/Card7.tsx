...
const Card7: React.FC<Card7Props> = ({ userId, role }) => {
  ...
  const links = [
    {
      title: "Mailjet Emails Sent",
      href: `/ModuleGlobal/ERP/Email/Mailjet/SentEmails${userId ? `?id=${encodeURIComponent(userId)}` : ""}`,
      description: "Monitor all email communications sent using the Mailjet email marketing system.",
    }
  ];
  ...
  return (
    <>
      ...
      <div className="p-4 rounded-lg shadow hover:shadow-lg transition duration-300">
        ...
        />
        <h3 className="text-md font-semibold mb-1">Mailjet</h3>
        <p className="text-sm text-gray-700 mb-4">
          A collaborative platform for sending, tracking, and managing marketing emails.
        </p>
        <button
        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white w-full max-w-md md:max-w-2xl p-6 rounded-lg shadow-xl relative">
            ...
            <div className="text-sm text-gray-600 mb-4">
              ...
              <span className="font-medium text-gray-800">Mailjet</span>
            </div>

            {/* Title */}
            <h2 className="text-lg font-bold mb-4">Mailjet Module</h2>
