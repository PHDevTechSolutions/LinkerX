      ...
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full md:w-1/2 px-4 mb-4">
          ...
          <select id="Gender" value={Gender} onChange={(e) => setGender(e.target.value)}
            className="w-full px-3 py-2 border-b bg-white rounded text-xs"
        ...
        <div className="w-full md:w-1/2 px-4 mb-4">
          ...
          <select id="CustomerSegment" value={CustomerSegment} onChange={(e) => setCustomerSegment(e.target.value)}
            className="w-full px-3 py-2 border-b bg-white rounded text-xs"
        ...
        <div className="w-full md:w-1/2 px-4 mb-4">
          ...
          <input type="text" id="CityAddress" value={CityAddress} onChange={(e) => setCityAddress(e.target.value)}
            className="w-full px-3 py-2 border-b text-xs capitalize"
