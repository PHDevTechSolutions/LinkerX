...
// Route
import Form from "../../../components/Ecodesk/Tracking/Form";
import Filters from "../../../components/Ecodesk/Tracking/Filters";
import Table from "../../../components/Ecodesk/Tracking/Table";
// Toast Notifications
...
const ReceivedPO: React.FC = () => {
    ...
    const fetchAccounts = async () => {
        try {
            const response = await fetch("/api/Data/Applications/Ecodesk/Tracking/Fetch");
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const response = await fetch("/api/Data/Applications/Ecodesk/Tracking/FetchUser"); // API endpoint mo
                const data = await response.json();
                setUsersList(data);
            } catch (error) {
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch(`/api/Data/Applications/Ecodesk/Tracking/Delete`, {
                method: "DELETE",
                headers: {
