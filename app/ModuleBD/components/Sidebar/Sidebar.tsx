  ...
  const menuItems = [
    {
      ...
      icon: BsBuildings,
      subItems: [
        { title: 'List of Company Accounts', href: `/ModuleBD/BD/Companies/CompanyAccounts${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
        { title: 'For Deletion', href: `/ModuleBD/BD/Companies/DeletionCompanies${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
      ],
    },
    {
      title: 'Activities',
      icon: CiMemoPad,
      subItems: [
        { title: 'Task', href: `/ModuleBD/BD/Task/DailyActivity${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
        { title: 'Callbacks', href: `/ModuleBD/BD/Task/Callback${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
        { title: 'Client Coverage Guide', href: `/ModuleBD/BD/Task/ClientCoverageGuide${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
        { title: 'Reports', href: `/ModuleBD/BD/Task/HistoricalRecords${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: CiSettings,
      subItems: [
        { title: 'Update Profile', href: `/ModuleBD/BD/Profile/Profile${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
        { title: 'Developers', href: `/ModuleBD/BD/Profile/Developers${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
      ],
    },
    {
      title: 'Help Center',
      icon: IoHelp,
      subItems: [
        { title: 'Tutorials', href: `/ModuleBD/BD/HelpCenter/Tutorials${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
      ],
    },
    {
      ...
      icon: CiCircleInfo,
      subItems: [
        { title: 'View Information', href: `/ModuleBD/BD/Information${userId ? `?id=${encodeURIComponent(userId)}` : ''}` },
      ],
    },
  ];
      ...
      >
        ...
        <div className="flex items-center justify-between p-5">
          <div className="flex items-center">
            ...
            <Link href={`/ModuleBD/BD/Dashboard${userId ? `?id=${encodeURIComponent(userId)}` : ''}`}>
        ...
        <div className="flex flex-col items-center flex-grow overflow-y-auto text-xs p-2">
          <div className="w-full">
            <Link
              href={`/ModuleBD/BD/Dashboard/${userId ? `?id=${encodeURIComponent(userId)}` : ''}`}
