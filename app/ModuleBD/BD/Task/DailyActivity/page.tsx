...
// Components
import AddManualForm from "../../../components/Task/DailyActivity/Form";
import SearchFilters from "../../../components/Task/DailyActivity/Filters";
import UsersTable from "../../../components/Task/DailyActivity/Table";
        ...
        ? posts
            .filter((post) => {
                ...
                const matchesRole =
                    ...
                    userDetails.Role === "Business Development Officer" ||
                    userDetails.Role === "Business Development Manager";
