    ...
    <SessionChecker>
      <ParentLayout>
        <div className="container mx-auto p-4">
          {(userDetails.Role === "Special Access" || userDetails.Role === "Business Development Manager") && (
            <>
          ...
          {(userDetails.Role === "Business Development Officer" || userDetails.Role === "Busines Development Manager") && (
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                {/* Total Work Hours */}
