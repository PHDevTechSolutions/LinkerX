...
const Page: React.FC = () => {
    ...
    const fetchLinks = async () => {
        try {
            const res = await fetch('/api/Data/Notes/Fetch');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const endpoint =
            mode === 'add'
                ? '/api/Data/Notes/Create'
                : `/api/Data/Notes/Edit?id=${selected?._id}`;
    ...
    const confirmDelete = async () => {
        if (!selected) return;
        try {
            const res = await fetch(`/api/Data/Notes/Delete?id=${selected._id}`, {
                method: 'DELETE',
            });
            if (!res.ok) {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <h2 className="text-lg font-semibold mb-4">
                                                {mode === 'add' ? 'Add New Note' : 'Update Note'}
                                            </h2>
                                            <Form
                                                mode={mode}
                                                formData={formData}
                                ...
                                <div className="mb-4 p-4 border bg-white shadow-md rounded-lg">
                                    ...
                                    <p className="text-xs text-gray-600 mb-4">
                                        Easily create, view, update, and share your personal notes. Keep track of important information and manage your notes efficiently using the table below.
                                    </p>
