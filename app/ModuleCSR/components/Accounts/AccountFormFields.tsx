    ...
    <>
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full sm:w-1/1 md:w-1/2 px-4 mb-4">
          ...
          <input type="text" id="ContactNumber" value={ContactNumber} onChange={(e) => setContactNumber(e.target.value)} className="w-full px-3 py-2 border rounded text-xs" required />
        </div>
        ...
        <div className="w-full sm:w-1/1 md:w-1/2 px-4 mb-4">
          ...
          <select id="CustomerType" value={CustomerType} onChange={(e) => setCustomerType(e.target.value)} className="w-full px-3 py-2 border bg-gray-50 rounded text-xs" required>
        ...
        <div className="w-full sm:w-1/1 md:w-1/2 px-4 mb-4">
          ...
          <input type="text" id="CityAddress" value={CityAddress} onChange={(e) => setCityAddress(e.target.value)} className="w-full px-3 py-2 border rounded text-xs capitalize" required />
        </div>
      </div>
