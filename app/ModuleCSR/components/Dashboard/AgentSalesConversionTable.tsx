                ...
                <table className="w-full border-collapse border border-gray-200 text-xs">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border p-2">% Conversion Inquiry to Sale</th>
                            <th className="border p-2">Ave Transaction Unit</th>
                            <th className="border p-2">Ave Transaction Value</th>
                    ...
                    <tbody>
                        {filteredMetrics.map((metric, index, array) => (
                            <React.Fragment key={index}>
                                ...
                                {(index === 0 || array[index - 1].userName !== metric.userName) && (
                                ...
                                <tr className="text-center border-t">
                                    <td className="border p-2 capitalize">{metric.userName}</td>
                                    ...
                                    <td className="border p-2">{metric.totalQtySold}</td>
                                    <td className="border p-2">{metric.convertedSalesCount}</td>
                                    <td className="border p-2"></td>
                                    <td className="border p-2">{metric.avgtransactionUnit}</td>
                                    <td className="border p-2">{metric.avgtransactionValue}</td>
