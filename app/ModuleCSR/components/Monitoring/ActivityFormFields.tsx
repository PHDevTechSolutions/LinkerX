            ...
            <div className="flex flex-wrap -mx-4">
                ...
                <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
                    ...
                    <select id="SalesManager" value={SalesManager || ""} onChange={(e) => setSalesManager(e.target.value)} className="w-full px-3 py-2 border bg-gray-50 rounded text-xs" required>
                        ...
                        <option value="RR-SLN-000">Rudolf Rosales</option>
                        <option value="NTL-DVO-000">Nathan Legazpi</option>
                        <option value="AD-NCR-000">Anjello Divinagracia</option>
                        <option value="SH-DA-000">Sette Hosena</option>
                        <option value="RDC-R1-000 ">Ronald Dela Cueva</option>
                        <option value="JD-PBS-000">James Danganan</option>
