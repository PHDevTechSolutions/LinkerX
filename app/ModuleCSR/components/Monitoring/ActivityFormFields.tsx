            ...
            <div className="flex flex-wrap -mx-4">
                ...
                <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
                    ...
                    <select id="SalesManager" value={SalesManager || ""} onChange={(e) => setSalesManager(e.target.value)} className="w-full px-3 py-2 border bg-gray-50 rounded text-xs">
                        ...
                        <option value="">Angie Baldugo</option>
                        <option value="">Roy Tayuman</option>
                        <option value="">Rudolf Rosales</option>
                        <option value="">Nathan Legazpi</option>
                        <option value="">Sette Hosena</option>
                        <option value="">Ronald Dela Cueva</option>
                        <option value="">James Danganan</option>
                        <option value="">Elizabeth Mabalay</option>
                        <option value="">Robert Gonzales</option>
                ...
                <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
                    ...
                    <select id="SalesAgent" value={SalesAgent || ""} onChange={(e) => setSalesAgent(e.target.value)} className="w-full px-3 py-2 border bg-gray-50 rounded text-xs">
                        ...
                        <option value="">Andrew Banaglorosio</option>
                        <option value="">Annie Mabilanga</option>
                        <option value="">Ansley Patelo</option>
                        <option value="">Banjo Lising</option>
                        <option value="">Cesar Paredes</option>
                        <option value="">Cris Acierto</option>
                        <option value="">Cristy Bobis</option>
                        <option value="">Dionisio Doyugan</option>
                        <option value="">Duke Menil</option>
                        <option value="">Erish Tomas Cajipe</option>
                        <option value="">Erwin Laude</option>
                        <option value="">Eryll Joyce Encina</option>
                        <option value="">Florencio Jacinto Jr</option>
                        <option value="">Gene Mark Roxas</option>
                        <option value="">Gretchell Aquino</option>
                        <option value="">Jean Dela Cerna</option>
                        <option value="">Jeff Puying</option>
                        <option value="">Jeffrey Lacson</option>
                        <option value="">Jessie De Guzman</option>
                        <option value="">Jessie Deguzman</option>
                        <option value="">Jonna Clarin</option>
                        <option value="">Jujeno Marie Del Rio</option>
                        <option value="">Julius Abuel</option>
                        <option value="">Joseph Candazo</option>
                        <option value="">Khay Yango</option>
                        <option value="">Krista Ilaya</option>
                        <option value="">Krizelle Payno</option>
                        <option value="">Kurt Guanco</option>
                        <option value="">Lotty Deguzman</option>
                        <option value="">Mark Villagonzalo</option>
                        <option value="">Michael Quijano</option>
                        <option value="">Merie Tumbado</option>
                        <option value="">Patrick Managuelod</option>
                        <option value="">Paula Cauguiran</option>
                        <option value="">Princess Joy Ambre</option>
                        <option value="">Raegan Bautista</option>
                        <option value="">Reynaldo Piedad</option>
                        <option value="">Randy Bacor</option>
                        <option value="">Rodelio Ico</option>
                        <option value="">Rodolfo Delizo</option>
                        <option value="">Rosemarie Nollora</option>
                        <option value="">Roselyn Barnes</option>
                        <option value="">Sherilyn Rapote</option>
                        <option value="">Vincent Bote</option>
                        <option value="">Vincent Ortiz</option>
                        <option value="">Wilnie Ardelozo</option>
