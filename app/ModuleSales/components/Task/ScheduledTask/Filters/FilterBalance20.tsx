...
const FilterBalance20: React.FC<FilterCardProps> = ({
  userDetails,
  posts,
  handleSubmit,
  expandedIds,
  ...
  useEffect(() => {
    const storedData = localStorage.getItem("balance20_add_tracker");
    if (storedData) {
      ...
      <div className="grid">
        ...
        {currentPosts.length === 0 && (
          <p className="text-xs text-center text-gray-500">
            No Balance 20 accounts to display.
          </p>
        )}
...
export default FilterBalance20;
